...
class App extends Component {
  ...
  constructor() {
    ...
    this.state = {
      ...
      isLandingPageImageLoaded : false,
    }
  }
  ...
  /**
   * README: (!!!) 
   *  For the record, this code was written on GTJD (GET THE JOB DONE) 
   *  basis as I first began web development without prior work 
   *  experience, and also before I started doing web projects.
   * 
   *  Please don't judge the way this awful code looks as a basis for 
   *  how I will write code at your company.
   *  I promise I have picked up some best practices and patterns along
   *  the way.
   * 
   *    Sincerely, 
   *      -Ned
      ...
      <div class="App">
        <LoadingOverlay
          ...
          spinner={<ClimbingBoxLoader 
            ...
            />}
          text="It'll be there in a jiffy..."
          >
          <div class="container">
            <section id="LandingPage">
              <div class="landing-flex-grid">
                <img onLoad={this.handleImageLoaded.bind(this)} alt="" class="profile-picture" src={require("./assets/resizedprofilepicture.jpg")}></img >
